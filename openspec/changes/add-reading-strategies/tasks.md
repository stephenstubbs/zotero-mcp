...
- [ ] 1.7 Document color mapping for SQ3R
...
- [ ] 2.6 Document output format for synthesis matrix
- [ ] 2.7 Test with sample research paper
...
- [ ] 3.6 Document depth parameter options
- [ ] 3.7 Test with argumentative paper
...
- [ ] 4.5 Document time constraints
- [ ] 4.6 Test with sample paper (verify <10 min completion)
