...
1. **Read project.md** - Review project conventions (coding style, module structure, testing requirements)
...
5. **Implement tasks sequentially** - Complete in order, following project.md conventions
